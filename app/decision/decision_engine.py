...
class DecisionEngine:
    ...
    async def decide(self, task: str, task_id: str | None = None) -> DecideResponse:
        ...
        for source, raw_result in zip(sources, raw_results):
            ...
            total_keyword_hits += len(raw_result.keyword.hits)
            total_vector_hits += len(raw_result.vector.hits)
            ...
            ).select(raw_result.keyword.hits, raw_result.vector.hits)
